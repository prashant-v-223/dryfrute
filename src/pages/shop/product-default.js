...
const ProductDefaultPage = () => {
  ...
  const [selectesdata, setdata] = useState([]);
  useEffect(() => {
    let d = localStorage.getItem("selectesdata");
                    ...
                    <div className="shop-details-img">
                      ...
                      >
                        <button
                          ...
                          id="view-pills-img1-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#view-pills-img1"
                          type="button"
                          role="tab"
                          aria-controls="view-pills-img1"
                          aria-selected="true"
                        >
                          <img src={selectesdata?.ImageSrc} alt="" />
                        </button>
                  ...
                  <div className="col-lg-6">
                    <div className="shop-details-content">
                      ...
                      <div className="price-area">
                        <p className="price">
                          ₹ {selectesdata?.VariantPrice}
                          <del className="px-3">
                            ₹ {selectesdata?.VariantCompareAtPrice}
                          </del>
                        </p>
                      </div>
                      ...
                      <div className="payment-method">
                        ...
                        <ul className="payment-card-list">
                          ...
                          <li>
                            <img
                              src="/assets/img/inner-page/payment-img5.svg"
                              alt=""
                            />
                          </li>
                          <li>
                          ...
                          <li>
                            <img
                              src="/assets/img/inner-page/payment-img7.svg"
                              alt=""
                            />
                          </li>
                        </ul>
                      ...
                      <div className="row">
                            ...
                            <ul className="author-comment mb-100">
                              <li>
                                <div className="author-img">
                                  <img
                                    src="/assets/img/inner-page/comment-author1.png "
                                    alt=""
                                  />
                                </div>
                                <div className="comment-content">
                                  ...
                                  <p>
                                    Odio tellus, dignissim fermentumara purus
                                    nec, consequat dapibus metus.Vivamusut urna
                                    world classo mauris, faucibus at egestas
                                    quis, fermentum egetonav neque. Duisonajt
                                    pharetra lectus nec risusonota and we are
                                    always support our customer support
                                    available.
                                  </p>
                              ...
                              <li>
                                <div className="author-img">
                                  <img
                                    src="/assets/img/inner-page/comment-author2.png "
                                    alt=""
                                  />
                                </div>
                                <div className="comment-content">
                                  <div className="author-post style-2">
                                    <div className="author-info">
                                      <h5>
                                        James Jordan, <span> 04 June,2023</span>
                                      </h5>
                                    </div>
                                    <ul className="rating">
                                      <li>
                        ...
                        <div className="col-lg-5">
                          <div className="comment-section style-3">
                            ...
                            <p>
                              Your email adress will be save &amp; secure, Also
                              not published.
                            </p>
