...
const ShopPage = () => {
  ...
  const [selectesdata, setselectesdata] = useState({});
  ...
  useEffect(() => {
    ...
    const handleOutsideClick = (e) => {
      if (isOpenSiebar && sidebarRef.current && !sidebarRef.current.contains(e.target)) {
        setIsOpenSidebar(false);
      }
      if (isOpenSiebar && sidebarBtnRef.current && !sidebarBtnRef.current.contains(e.target)) {
        setIsOpenSidebar(false);
      }
    };
  ...
  return (
    ...
    <>
      <div className={`filter-sidebar ${isOpenSiebar ? "slide" : ""}`} ref={sidebarRef}>
        <div className="sidebar-area px-4">
          <div className="shop-widget mb-30  px-5">
            <div className="check-box-item">
              ...
              <ul className="shop-item">
                ...
                <li>
                  <Link legacyBehavior href="/shop"><a>Cycling</a></Link>
                </li>
                <li>
                        ...
                        <div className="product-card-img double-img">
                          ...
                          <div className="overlay" style={{
                            ...
                            <div className="cart-area"
                              onClick={() => {
                                let olddata = JSON.parse(localStorage.getItem("carditams")) ? JSON.parse(localStorage.getItem("carditams")) : []
                                let dataaxist = JSON.parse(localStorage.getItem("carditams"))?.find((item) => {
                              ...
                              <Link legacyBehavior href="/shop/cart">
                                <a className="hover-btn3 add-cart-btn"><i className="bi bi-bag-check" /> Add To Cart</a>
                              </Link>
                            </div>
                          </div>
                          <div className="view-and-favorite-area">
                            <ul>
                              <li>  <a data-bs-toggle="modal" data-bs-target="#product-view" onClick={() => {
                                setselectesdata(e)
                              }}>
                      ...
                      <div className="tab-content" id="view-tabContent">
                        <div className="tab-pane fade show active" id="view-pills-img1" role="tabpanel">
                          <div className="shop-details-tab-img">
                            <img src={selectesdata.ImageSrc} alt="" />
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="shop-details-content">
                      ...
                      <div className="price-area">
                        <p className="price">₹ {selectesdata.VariantPrice}<del className='px-3'>₹ {selectesdata.VariantCompareAtPrice}</del></p>
                      </div>
