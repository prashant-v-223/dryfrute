...
const checkout = () => {
  ...
  const [address123, setaddress] = useState({});
  ...
  let upiid = "mab.037322034880096@axisbank";
            ...
            <div className="card py-1 max-height">
              <form onSubmit={handleSubmit}>
                <div className="card-body">
                  ...
                  >
                    <button className="primary-btn1 hover-btn3 w-100 " type="submit" >
                      Save Address
                    </button>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <img
                    ...
                    height={58}
                  />
                  <span className="unaviablee px-4">G Pay</span>
                </label>
              </div>
              <div
                id="divphonepe"
