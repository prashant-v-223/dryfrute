...
const NewestProduct = () => {
  ...
  return (
    <>
                            ...
                            <div className="product-card hover-btn">
                              <div className="product-card-img double-img">
                                ...
                                <div className="view-and-favorite-area">
                                  <ul>
                                    <li>
                                      <a data-bs-toggle="modal" data-bs-target="#product-view123" onClick={() => {
                                        setselectesdata(e)
                                      }}>
                              ...
                              <div className="product-card-content">
                                <h6
                                  ...
                                  <a className="hover-underline" href="/shop/product-default">{e.Title}</a>
                                </h6>
      ...
      <div className="modal product-view-modal" id="product-view123">
